-- BigQuery DDL for registering UDFs in the EU project (acme-analytics-eu, dataset: udfs)

-- =============================================================================
-- 1. normalize_country (Native JavaScript UDF)
-- =============================================================================
CREATE OR REPLACE FUNCTION `${PROJECT_EU}.${DS_UDFS}.normalize_country`(country STRING)
RETURNS STRING
DETERMINISTIC
LANGUAGE js
AS """
...
-- =============================================================================
CREATE OR REPLACE FUNCTION `${PROJECT_EU}.${DS_UDFS}.hash_customer_email`(email STRING)
RETURNS STRING
DETERMINISTIC
LANGUAGE js
AS """
...
-- =============================================================================
CREATE OR REPLACE FUNCTION `${PROJECT_EU}.${DS_UDFS}.parse_legacy_sku`(sku STRING)
RETURNS STRING
DETERMINISTIC
LANGUAGE js
AS """
...
-- =============================================================================
CREATE OR REPLACE FUNCTION `${PROJECT_EU}.${DS_UDFS}.geoip_city`(ip STRING)
RETURNS STRING
REMOTE WITH CONNECTION `${PROJECT_EU}.eu.remote-udfs`
OPTIONS (
  endpoint = 'https://europe-west3-acme-analytics-eu.cloudfunctions.net/geoip_city'
);

-- =============================================================================
-- 5. lookup_supplier_terms (Cloud Functions-backed Remote UDF)
-- =============================================================================
CREATE OR REPLACE FUNCTION `${PROJECT_EU}.${DS_UDFS}.lookup_supplier_terms`(supplier_id STRING)
RETURNS INT64
REMOTE WITH CONNECTION `${PROJECT_EU}.eu.remote-udfs`
OPTIONS (
  endpoint = 'https://europe-west3-acme-analytics-eu.cloudfunctions.net/lookup_supplier_terms'
);
